  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex items-center gap-2 mb-6">
        <Link to="/" className="text-sm text-gray-500 hover:text-gray-700">首页</Link>
        <span className="text-gray-300">/</span>
        <span className="text-sm text-gray-900">全部 Skill</span>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <aside className="lg:w-52 shrink-0 space-y-5">
          <div>
            <h3 className="text-sm font-medium text-gray-700 mb-2">类型</h3>
